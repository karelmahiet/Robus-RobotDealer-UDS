...
//     // Création d'un code d'état pour les conditions de ligne
//     int etat = 0;
//     if (etatLigneGauche > limiteDetectionCouleur) etat += 1;    // Noir à gauche
//     if (etatLigneMilieu > limiteDetectionCouleur) etat += 2;    // Noir au milieu
//     if (etatLigneDroit > limiteDetectionCouleur) etat += 4;     // Noir à droite

//     switch (etat) {
//         case 1: // Noir, X, Blanc (tourne à gauche)
//             vitesseDroit = vitesseDroitLent;
//             vitesseGauche = vitesseGaucheTresLent;
//             avance();
//             break;
        
//         case 4: // Blanc, X, Noir (tourne à droite)
//             vitesseDroit = vitesseDroitTresLent;
//             vitesseGauche = vitesseGaucheLent;
//             avance();
//             break;

//         case 7: // Noir, Noir, Noir (arrête)
//             delay(150);
//             arret(true);
//             ENCODER_Reset(0);
//             ENCODER_Reset(1);
...
//         case 2: // Blanc, Noir, Blanc (avance tout droit)
//         default:
//             vitesseDroit = vitesseDroitLent;
//             vitesseGauche = vitesseGaucheLent;
//             avance();
